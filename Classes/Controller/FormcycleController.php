...
class Tx_XmFormcycle_Controller_FormcycleController extends Tx_Extbase_MVC_Controller_ActionController {
	...
	public function listAction() {
		...
		list($nix, $projectId) = explode("pid=", $selProjectId);
		
		$fch = new FcHelper();
		$fc_ContentUrl = $fch->getFormContent($projectId,t3lib_div::getIndpEnv('TYPO3_SITE_URL'), $selOkPage, $selErrorPage, $usejq, $useui, $usebs,$frontendLang);
