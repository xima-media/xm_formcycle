...
$tempFields = [
    'tx_xmformcycle_display_mode' => [
        ...
        'config' => [
            ...
            'items' => [
                ['label' => 'LLL:EXT:xm_formcycle/Resources/Private/Language/locallang.xlf:tx_xmformcycle_display_mode.0', 'value' => 0],
                ['label' => 'LLL:EXT:xm_formcycle/Resources/Private/Language/locallang.xlf:tx_xmformcycle_display_mode.1', 'value' => 1],
            ],
            'default' => 0,
        ],
    ],
    ...
    'tx_xmformcycle_detail_link_mode' => [
        ...
        'config' => [
            ...
            'renderType' => 'selectSingle',
            'items' => [
                ['label' => 'LLL:EXT:xm_formcycle/Resources/Private/Language/locallang.xlf:tx_xmformcycle_detail_link_mode.0', 'value' => 0],
                ['label' => 'LLL:EXT:xm_formcycle/Resources/Private/Language/locallang.xlf:tx_xmformcycle_detail_link_mode.1', 'value' => 1],
            ],
        ],
    ],
    'tx_xmformcycle_integration_mode' => [
        ...
        'config' => [
            ...
            'renderType' => 'selectSingle',
            'items' => [
                ['label' => 'LLL:EXT:xm_formcycle/Resources/Private/Language/locallang.xlf:tx_xmformcycle_integration_mode.0', 'value' => 0],
                ['label' => 'LLL:EXT:xm_formcycle/Resources/Private/Language/locallang.xlf:tx_xmformcycle_integration_mode.1', 'value' => 1],
                ['label' => 'LLL:EXT:xm_formcycle/Resources/Private/Language/locallang.xlf:tx_xmformcycle_integration_mode.2', 'value' => 2],
                ['label' => 'LLL:EXT:xm_formcycle/Resources/Private/Language/locallang.xlf:tx_xmformcycle_integration_mode.3', 'value' => 3],
                ['label' => 'LLL:EXT:xm_formcycle/Resources/Private/Language/locallang.xlf:tx_xmformcycle_integration_mode.4', 'value' => 4],
            ],
        ],
    ],
